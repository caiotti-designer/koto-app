                  ...
                  <div>
                    ...
                    <div className="relative">
                      <button
                        ...
                        className="w-full px-3 py-2 border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors flex items-center justify-between"
                      >
                        <span>{formData.selectedProject || 'Select a project...'}</span>
                        <ChevronDown className="w-4 h-4 text-gray-500 dark:text-slate-400" />
                      </button>
                      {showProjectDropdown && (
                        <div className="absolute top-full left-0 right-0 mt-1 bg-white dark:bg-slate-700 border border-gray-200 dark:border-slate-600 rounded-lg shadow-lg z-20 max-h-48 overflow-y-auto">
                          <button
                            onClick={() => {
                              setFormData(prev => ({ ...prev, selectedProject: '' }));
                              setShowProjectDropdown(false);
                            }}
                            className="w-full px-3 py-2 text-left text-gray-500 dark:text-slate-400 hover:bg-gray-50 dark:hover:bg-slate-600 first:rounded-t-lg transition-colors"
                          >
                            No project
                          </button>
                          {categories.map(project => (
                            <button
                              ...
                              className="w-full px-3 py-2 text-left text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-slate-600 last:rounded-b-lg transition-colors"
                            >
                              {project.name}
                            </button>
                          ))}
